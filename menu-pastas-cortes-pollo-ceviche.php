...
<html lang="es-MX">
	<head>
		<title>Zazón - Menu de Carnes, Carnes, Pollo y Ceviche</title>
		<!-- Meta Tags -->
		<meta charset="UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
		<!-- SEO -->
		<meta name="robots" content="index, follow">
		<meta name="description" content="Restaurant Bar - Menu de Carnes, Carnes, Pollo y Ceviche">
		<!-- Favicon -->
	...
	<body class="top">
		<div class="container">
			...
			<div class="content-wrapper">
				<div class="content">
						<?php include('_components/menu-card-2.php'); ?>
				</div><!-- END .content -->
