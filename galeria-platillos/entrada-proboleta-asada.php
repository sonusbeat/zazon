...
<html lang="es-MX">
		<!-- Title -->
		<title>Zazón - Proboleta Asada</title>
		<!-- Meta Tags -->
		<meta charset="UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
		<!-- SEO -->
		<meta name="robots" content="index, follow">
		<meta name="description" content="Imagen del Platillo Proboleta Asada">
		<!-- Favicon -->
										...
										<div class="content">
											<div class="full-width-content">
												...
												<div class="photo-gallery-open">
													<h3>Proboleta Asada</h3>
													<img src="../images/platillos/entrada-proboleta-asada.jpg" alt="Entrada Proboleta Asada" class="image" />
