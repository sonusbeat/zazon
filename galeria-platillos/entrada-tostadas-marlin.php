...
<html lang="es-MX">
		<!-- Title -->
		<title>Zazón - Tostada de Marlin</title>
		<!-- Meta Tags -->
		<meta charset="UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
		<!-- SEO -->
		<meta name="robots" content="index, follow">
		<meta name="description" content="Imagen de Tostadas de Marlin">
		<!-- Favicon -->
										...
										<div class="content">
											<div class="full-width-content">
												...
												<div class="photo-gallery-open">
													<h3>Tostadas de Marlin</h3>
													<img src="../images/platillos/entrada-tostadas-marlin.jpg" alt="Entrada Chistorra" class="image" />
