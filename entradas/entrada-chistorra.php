...
<html lang="es-MX">
		<!-- Title -->
		<title>Zazón - Chistorra</title>
		<!-- Meta Tags -->
		<meta charset="UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
		<!-- SEO -->
		<meta name="robots" content="index, follow">
		<meta name="description" content="Imagen del Platillo Entrada Chistorra">
		<!-- Favicon -->
										...
										<div class="content">
											<div class="full-width-content">
												...
												<div class="photo-gallery-open">
													<h3>Chistorra</h3>
													<img src="../images/platillos/entrada-chistorra.jpg" alt="Entrada Chistorra" class="image" />
