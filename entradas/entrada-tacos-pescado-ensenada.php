...
<html lang="es-MX">
		<!-- Title -->
		<title>Zazón - Tacos de Pescado Ensenada</title>
		<!-- Meta Tags -->
		<meta charset="UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
		<!-- SEO -->
		<meta name="robots" content="index, follow">
		<meta name="description" content="Imagen de Tacos de Pescado Ensenada">
		<!-- Favicon -->
										...
										<div class="content">
											<div class="full-width-content">
												...
												<div class="photo-gallery-open">
													<h3>Tacos de Pescado Ensenada</h3>
													<img src="../images/platillos/entrada-tacos-pescado-ensenada.jpg" alt="Entrada Chistorra" class="image" />
