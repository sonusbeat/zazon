			...
			<div class="content-wrapper">
				<div id="card-container" activepage="1">
					<div class="content" id="card-slider">
						<?php include('_components/menu-content/card-page-3.html'); ?>
					</div><!-- END .card-slider -->
				</div><!-- END .card-container -->
			</div><!-- END .content-wrapper -->	
		</td><!-- END .homepage-about -->
		<td class="navigation"><a href="/menu-bebidas-vinos-licores.php" class="next" id="card-next" title="Ir al siguiente menú">&nbsp;</a></td>
	</tr>
	<tr>
		<td></td>
